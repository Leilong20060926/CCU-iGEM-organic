...
export const STR = {
  ...
  heroP: {
    zh: "查詢全台有機、友善耕作的驗證資訊與經營者，用圖片點選農產品就能找到販售業者，也能用地圖依作物與所在位置，找出離你最近的賣家。",
    en: "Look up organic and friendly-farming certification info nationwide, browse produce by picture to find sellers, or use the map to find the nearest vendor by crop and location.",
  } as Bi,
  heroStamp: { zh: "有機友善\n查詢系統", en: "ORGANIC & FRIENDLY\nCERT LOOKUP" } as Bi,
  ...
  goMapSub: { zh: "看看住家附近有哪些有機、友善驗證業者", en: "Find certified organic and friendly-farming operators near you" } as Bi,
  ...
  mapTitle: { zh: "全台有機、友善驗證分布地圖", en: "Nationwide organic & friendly-farming certification map" } as Bi,
